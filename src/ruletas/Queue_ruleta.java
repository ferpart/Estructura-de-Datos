...
import imports.Joptions; //importar libreria utilizada para agilizar el uso de JOptionsPane (una gui para recibir datos)
...
public class Queue_ruleta {
	...
	public static void anadir(GQueue<String> queue_main){ //metodo encargado de añadir elementos, asi como removerlos e imprimirlos en forma de lista en el gui
		Joptions<String> user_input= new Joptions<String>(); //implementacion de la libreria creada para el JOptionsPane
