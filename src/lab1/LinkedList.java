...
public interface LinkedList<E> {
	...
	public boolean contains(E ítem); //Devuelve true si el ítem se encuentra en la lista, falso en caso contrario.
	...
	public boolean add(int index, E item); //Agrega el ítem a la lista en la posición índex si éste es válido.
